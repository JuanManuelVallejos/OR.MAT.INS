		...
		<div id="list-division" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="division" title="${message(code: 'division.division.label', default: 'Division')}" />
				...
				<g:each in="${divisionInstanceList}" status="i" var="divisionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${divisionInstance.id}">${fieldValue(bean: divisionInstance, field: "division")}</g:link></td>
